    ...
    return (
        <div className="space-y-6 pb-10">
            ...
            <div className="text-left">
                ...
                <p className="text-gray-500 text-sm mt-1">Daftar produk yang Anda jual di platform.</p>
            </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 shadow-sm overflow-hidden">
                {loading ? (
                    <div className="p-12 flex justify-center items-center text-gray-500">
                        <Loader className="animate-spin mr-2 w-5 h-5" /> Memuat produk...
                    </div>
                    ...
                    <div className="p-12 flex flex-col items-center justify-center text-gray-500">
                        ...
                        <p className="text-base font-medium text-gray-900">Belum ada produk</p>
                        <p className="text-sm mt-1">Mulai dengan menambahkan produk baru Anda.</p>
                    </div>
                ) : (
                                    ...
                                    <tr key={product.product_id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="p-4 align-middle">
                                            <div className="flex items-center gap-4">
                                                ...
                                                <div>
                                                    <div className="font-bold text-gray-800 text-sm line-clamp-1">{product.name}</div>
                ...
                {filteredProducts.length > 0 && (
                    <div className="p-4 border-t border-gray-100 flex items-center justify-between bg-white">
                        <p className="text-xs text-gray-500">
                            Menampilkan <span className="font-bold text-gray-700">{(currentPage - 1) * itemsPerPage + 1}-{Math.min(currentPage * itemsPerPage, filteredProducts.length)}</span> dari <span className="font-bold text-gray-700">{filteredProducts.length}</span> produk
                        </p>
