    ...
    <footer className="bg-secondary text-secondary-foreground mt-16">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="font-bold text-lg mb-4">About Catalozy</h3>
            <ul className="space-y-2 text-sm opacity-90">
              ...
              <li><Link to="/press" className="hover:opacity-100">Press</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-90">
              <li><Link to="/catalog?category=fashion" className="hover:opacity-100">Fashion</Link></li>
              <li><Link to="/catalog?category=electronics" className="hover:opacity-100">Electronics</Link></li>
              <li><Link to="/catalog?category=food" className="hover:opacity-100">Food & Beverage</Link></li>
              <li><Link to="/catalog?category=crafts" className="hover:opacity-100">Handmade Crafts</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm opacity-90">
              ...
              <li><Link to="/seller" className="hover:opacity-100">Become a Seller</Link></li>
            </ul>
          </div>
